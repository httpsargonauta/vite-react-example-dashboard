import { UserDashboard, decrypt } from '../../functions/_functions';
          ...
          <main className="relative h-screen overflow-hidden  bg-neutral-950 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))]">
            <div className="flex items-start justify-between">
              <div className="flex flex-col w-full md:space-y-4">
                <div className="scroll h-screen px-4 pb-24 md:px-28 py-12">
                  <h1 className="text-4xl font-semibold  text-white">
                    Good afternoom, <span>{decrypt(userData.name)}</span>
                  </h1>
                  <h2 className="text-gray-400 text-md">
                    Here&#x27;s what&#x27;s happening with your ambassador
                    account today.
                  </h2>
                  ...
                  <div className="grid grid-cols-1 gap-4 my-4 md:grid-cols-2 lg:grid-cols-3">
                    <div className="w-full">
                      <div className="relative w-full px-4 py-6  shadow-lg bg-gray-700">
                        <p className="text-sm font-semibold  border-b border-gray-200 w-max text-white">
                          Project Reffered
                        </p>
                    ...
                    <div className="w-full">
                      <div className="relative w-full px-4 py-6  shadow-lg bg-gray-700">
                        ...
                        <div className="flex items-end my-6 space-x-2">
                          <p className="text-5xl font-bold  text-white">16</p>
                          <span className="flex items-center text-xl font-bold text-red-500">
                            <svg
                              width="20"
                              fill="currentColor"
